<div class="form-card">
	<form action='?A=processing' method='post' enctype='multipart/form-data'>
		...
		<ul class="form">
			<li><label>Menhely név: <input type="text" name="menhelyname" size="26" maxlength="128" placeholder="Max 128 karakter" autofocus required></label></li>
			<li><label>Email cím: <input type="email" name="email" size="26" maxlength="128" placeholder="valami@valami.hu" required></label></li>
			...
			<li><label>Telefonszám: <input type="tel" name="phone" size="16" placeholder="06(30)123-4678" required></label></li>
			<li><label>Rövid leírás: <textarea name="desc" cols="24" rows="5" maxlength="450" placeholder="Max 450 karakter"></textarea></label></li>
			<li><label>Weboldal: <input type="text" name="website" maxlength="128" size="26" placeholder="A menhely weblapja ha van"></label></li>
			<li><label>Város: <input type="text" name="city" maxlength="30" size="26" required></label></li>
			<li><label>Cím: <input type="text" name="cim" maxlength="128" size="26" required></label></li>
